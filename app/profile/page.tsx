...
export default function Profile() {
    ...
    const currentSpots = activeTab === "mySpots" ? mySpots : savedSpots;
        ...
        <main className="min-h-screen bg-gray-50/50 pb-28">
            ...
            <div className="px-5 pt-6">
                    ...
                    <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                            ...
                            <button
                                ...
                                className="bg-black text-white px-6 py-2 rounded-xl text-sm font-semibold hover:bg-gray-800 transition-colors"
                            >
                                Edit Profile
                            </button>
                        </div>
                ...
                <div className="flex gap-2 mb-6">
                    <button
                        onClick={() => setActiveTab("mySpots")}
                        className={`flex-1 py-3 rounded-xl font-semibold text-sm transition-all ${activeTab === "mySpots"
                            ? "bg-black text-white"
                    ...
                    <button
                        ...
                        className={`flex-1 py-3 rounded-xl font-semibold text-sm transition-all ${activeTab === "saved"
                            ? "bg-black text-white"
                            : "bg-white text-gray-600 border border-gray-200 hover:border-gray-300"
                            }`}
                    >
